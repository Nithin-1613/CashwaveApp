  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.get(
        `http://localhost:8080/api/policies?policynumber=${policy.policynumber}`
      );
      ...
      const linkAccountResponse = await axios.post('http://localhost:8080/api/policies/link-account', {
        ...policy,
