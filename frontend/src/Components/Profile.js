...
const Profile = () => {
 ...
 <NavBar/>
  ...
  <div className="card-body">
    <a href="#" className="btn btn-primary" style={{ backgroundColor: '#441475',color: 'white' }}>Transaction History</a>
  </div>
  </div>
  ...
  <div className="card-body">
    <a href="#" className="btn btn-primary" style={{ backgroundColor: '#441475',color: 'white' }}>Money transfer</a>
  </div>
  </div>
  <div className="card text-center mt-5" style={{ border: 'none' }} >
  ...
  <div className="card-body">
    <a href="#" className="btn btn-primary" style={{ backgroundColor: '#441475',color: 'white' }}>Credit card activities</a>
  </div>
  </div>
  <div className="card text-center mt-5" style={{ border: 'none' }} >
