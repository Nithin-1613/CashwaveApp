...
const PaymentPage = () => {
    ...
    const handlePayment = (e) => {
        ...
        axios.put('http://localhost:9090/transfer/nithin16/makeTransfer', transferreq)
            .then((response) => {
                ...
                <div className="row justify-content-center ">
                    <div className="col-md-6 formrow">
                        ...
                        <form onSubmit={handlePayment}>
                            ...
                            <button type="cancel" onClick={()=>{navigate("/transfer");
                        sessionStorage.clear();}}   className="btn btn-primary">
                                Cancel
                            </button>
                        </form>
                    </div>
